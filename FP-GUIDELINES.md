...
check was introduced: **7 findings across 6 files
and 491 lines**. CI compares against that budget and fails only when a
...
| `RS005` | 2 | warn | typed errors | untyped/erased error in a signature |
