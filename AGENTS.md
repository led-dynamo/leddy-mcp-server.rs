# AGENTS.md — led-dynamo/leddy-mcp-server.rs
...
- GitHub org: [`led-dynamo`](https://github.com/led-dynamo)
- Repository: [`led-dynamo/leddy-mcp-server.rs`](https://github.com/led-dynamo/leddy-mcp-server.rs)
- Local checkout: `~/codes/led-dynamo/leddy-mcp-server.rs`
...
- Sibling test org: `github.com/led-dynamo-test` (external/e2e coverage and extra GHA minutes)
- Slack workspace: oresoftware-workspace.slack.com
- Kind: product MCP server for this GitHub org
- Package / service name: `leddy-mcp-server`
